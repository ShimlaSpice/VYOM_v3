...
class StockDetails(QWidget):
    ...
    def _build_ui(self):
        ...
        layout.addWidget(QLabel("VYom Analysis"))

        self.reasons.setMaximumHeight(
            240,
        )

        layout.addWidget(self.reasons, 3,)

        self.summary.setMaximumHeight(
            180,
        )

        layout.addWidget(QLabel("Vyom Summary"))
